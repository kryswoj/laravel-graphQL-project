<template>
    <div class="container w-full md:w-3/4 lg:w-3/5 xl:w-1/2 mt-20">
        <div v-if="$apollo.loading">Loading...</div>

        <div v-else>
            <div class="text-lg text-gray-600">
                By {{ post.user.name }} in
                <router-link
            ...
            <h1 class="text-5xl mt-10 font-bold mb012">
                {{ post.title }}
            </h1>
            ...
            <div class="mb-24 flex">
                <div class="mr-6">
                    <img :src="`/storage/faces/${post.user.avatar}`" alt="User avatar" class="w-16 h-16 rounded-full">
                </div>
